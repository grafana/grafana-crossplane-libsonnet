...
* [spec.parameters.forProvider.spec.sourceMatchers](spec/parameters/forProvider/spec/sourceMatchers.md)
* [spec.parameters.forProvider.spec.targetMatchers](spec/parameters/forProvider/spec/targetMatchers.md)
* [spec.parameters.initProvider.spec.sourceMatchers](spec/parameters/initProvider/spec/sourceMatchers.md)
* [spec.parameters.initProvider.spec.targetMatchers](spec/parameters/initProvider/spec/targetMatchers.md)
  ...
  * [`obj parameters`](#obj-specparameters)
    ...
    * [`obj forProvider`](#obj-specparametersforprovider)
      ...
      * [`obj spec`](#obj-specparametersforproviderspec)
        * [`fn withEqual(value)`](#fn-specparametersforproviderspecwithequal)
        * [`fn withEqualMixin(value)`](#fn-specparametersforproviderspecwithequalmixin)
        * [`fn withSourceMatchers(value)`](#fn-specparametersforproviderspecwithsourcematchers)
        * [`fn withSourceMatchersMixin(value)`](#fn-specparametersforproviderspecwithsourcematchersmixin)
        * [`fn withTargetMatchers(value)`](#fn-specparametersforproviderspecwithtargetmatchers)
        * [`fn withTargetMatchersMixin(value)`](#fn-specparametersforproviderspecwithtargetmatchersmixin)
    * [`obj initProvider`](#obj-specparametersinitprovider)
      ...
      * [`obj spec`](#obj-specparametersinitproviderspec)
        * [`fn withEqual(value)`](#fn-specparametersinitproviderspecwithequal)
        * [`fn withEqualMixin(value)`](#fn-specparametersinitproviderspecwithequalmixin)
        * [`fn withSourceMatchers(value)`](#fn-specparametersinitproviderspecwithsourcematchers)
        * [`fn withSourceMatchersMixin(value)`](#fn-specparametersinitproviderspecwithsourcematchersmixin)
        * [`fn withTargetMatchers(value)`](#fn-specparametersinitproviderspecwithtargetmatchers)
        * [`fn withTargetMatchersMixin(value)`](#fn-specparametersinitproviderspecwithtargetmatchersmixin)
...
####### fn spec.parameters.forProvider.spec.withEqual

```jsonnet
spec.parameters.forProvider.spec.withEqual(value)
```
...
####### fn spec.parameters.forProvider.spec.withEqualMixin

```jsonnet
spec.parameters.forProvider.spec.withEqualMixin(value)
```
...
Labels that must have equal values in source and target alerts for the inhibition to take effect.
####### fn spec.parameters.forProvider.spec.withSourceMatchers

```jsonnet
spec.parameters.forProvider.spec.withSourceMatchers(value)
```
...
####### fn spec.parameters.forProvider.spec.withSourceMatchersMixin

```jsonnet
spec.parameters.forProvider.spec.withSourceMatchersMixin(value)
```
...
Matchers that must be satisfied for an alert to be a source of inhibition.
####### fn spec.parameters.forProvider.spec.withTargetMatchers

```jsonnet
spec.parameters.forProvider.spec.withTargetMatchers(value)
```
...
####### fn spec.parameters.forProvider.spec.withTargetMatchersMixin

```jsonnet
spec.parameters.forProvider.spec.withTargetMatchersMixin(value)
```
...
####### fn spec.parameters.initProvider.spec.withEqual

```jsonnet
spec.parameters.initProvider.spec.withEqual(value)
```
...
Labels that must have equal values in source and target alerts for the inhibition to take effect.
####### fn spec.parameters.initProvider.spec.withEqualMixin

```jsonnet
spec.parameters.initProvider.spec.withEqualMixin(value)
```
...
Labels that must have equal values in source and target alerts for the inhibition to take effect.
####### fn spec.parameters.initProvider.spec.withSourceMatchers

```jsonnet
spec.parameters.initProvider.spec.withSourceMatchers(value)
```
...
Matchers that must be satisfied for an alert to be a source of inhibition.
####### fn spec.parameters.initProvider.spec.withSourceMatchersMixin

```jsonnet
spec.parameters.initProvider.spec.withSourceMatchersMixin(value)
```
...
Matchers that must be satisfied for an alert to be a source of inhibition.
####### fn spec.parameters.initProvider.spec.withTargetMatchers

```jsonnet
spec.parameters.initProvider.spec.withTargetMatchers(value)
```
...
Matchers that must be satisfied for an alert to be inhibited.
####### fn spec.parameters.initProvider.spec.withTargetMatchersMixin

```jsonnet
spec.parameters.initProvider.spec.withTargetMatchersMixin(value)
```
