...
* [spec.parameters.forProvider.usersRef](spec/parameters/forProvider/usersRef.md)
* [spec.parameters.initProvider.usersRef](spec/parameters/initProvider/usersRef.md)
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj parameters`](#obj-specparameters)
    ...
    * [`obj forProvider`](#obj-specparametersforprovider)
      ...
      * [`fn withUsersRef(value)`](#fn-specparametersforproviderwithusersref)
      * [`fn withUsersRefMixin(value)`](#fn-specparametersforproviderwithusersrefmixin)
      * [`fn withUsersSelector(value)`](#fn-specparametersforproviderwithusersselector)
      * [`fn withUsersSelectorMixin(value)`](#fn-specparametersforproviderwithusersselectormixin)
      ...
      * [`obj usersSelector`](#obj-specparametersforproviderusersselector)
        * [`fn withMatchControllerRef(value=true)`](#fn-specparametersforproviderusersselectorwithmatchcontrollerref)
        * [`fn withMatchLabels(value)`](#fn-specparametersforproviderusersselectorwithmatchlabels)
        * [`fn withMatchLabelsMixin(value)`](#fn-specparametersforproviderusersselectorwithmatchlabelsmixin)
        * [`fn withPolicy(value)`](#fn-specparametersforproviderusersselectorwithpolicy)
        * [`fn withPolicyMixin(value)`](#fn-specparametersforproviderusersselectorwithpolicymixin)
        * [`obj policy`](#obj-specparametersforproviderusersselectorpolicy)
          * [`fn withResolution(value="Required")`](#fn-specparametersforproviderusersselectorpolicywithresolution)
          * [`fn withResolve(value)`](#fn-specparametersforproviderusersselectorpolicywithresolve)
    * [`obj initProvider`](#obj-specparametersinitprovider)
      ...
      * [`fn withUsersRef(value)`](#fn-specparametersinitproviderwithusersref)
      * [`fn withUsersRefMixin(value)`](#fn-specparametersinitproviderwithusersrefmixin)
      * [`fn withUsersSelector(value)`](#fn-specparametersinitproviderwithusersselector)
      * [`fn withUsersSelectorMixin(value)`](#fn-specparametersinitproviderwithusersselectormixin)
      ...
      * [`obj usersSelector`](#obj-specparametersinitproviderusersselector)
        * [`fn withMatchControllerRef(value=true)`](#fn-specparametersinitproviderusersselectorwithmatchcontrollerref)
        * [`fn withMatchLabels(value)`](#fn-specparametersinitproviderusersselectorwithmatchlabels)
        * [`fn withMatchLabelsMixin(value)`](#fn-specparametersinitproviderusersselectorwithmatchlabelsmixin)
        * [`fn withPolicy(value)`](#fn-specparametersinitproviderusersselectorwithpolicy)
        * [`fn withPolicyMixin(value)`](#fn-specparametersinitproviderusersselectorwithpolicymixin)
        * [`obj policy`](#obj-specparametersinitproviderusersselectorpolicy)
          * [`fn withResolution(value="Required")`](#fn-specparametersinitproviderusersselectorpolicywithresolution)
          * [`fn withResolve(value)`](#fn-specparametersinitproviderusersselectorpolicywithresolve)
...
call users (for single_event and recurrent_event event type).
The list of on-call users (for single_event and recurrent_event event type).
###### fn spec.parameters.forProvider.withUsersRef

```jsonnet
spec.parameters.forProvider.withUsersRef(value)
```
...
###### fn spec.parameters.forProvider.withUsersRefMixin

```jsonnet
spec.parameters.forProvider.withUsersRefMixin(value)
```
...
References to User in oncall to populate users.
###### fn spec.parameters.forProvider.withUsersSelector

```jsonnet
spec.parameters.forProvider.withUsersSelector(value)
```
...
###### fn spec.parameters.forProvider.withUsersSelectorMixin

```jsonnet
spec.parameters.forProvider.withUsersSelectorMixin(value)
```
...
the corresponding field is not present. Use 'Always' to resolve the
reference on every reconcile.
###### obj spec.parameters.forProvider.usersSelector


####### fn spec.parameters.forProvider.usersSelector.withMatchControllerRef

```jsonnet
spec.parameters.forProvider.usersSelector.withMatchControllerRef(value=true)
```
...
MatchControllerRef ensures an object with the same controller reference
as the selecting object is selected.
####### fn spec.parameters.forProvider.usersSelector.withMatchLabels

```jsonnet
spec.parameters.forProvider.usersSelector.withMatchLabels(value)
```
...
MatchLabels ensures an object with matching labels is selected.
####### fn spec.parameters.forProvider.usersSelector.withMatchLabelsMixin

```jsonnet
spec.parameters.forProvider.usersSelector.withMatchLabelsMixin(value)
```
...
MatchLabels ensures an object with matching labels is selected.
####### fn spec.parameters.forProvider.usersSelector.withPolicy

```jsonnet
spec.parameters.forProvider.usersSelector.withPolicy(value)
```
...
Policies for selection.
####### fn spec.parameters.forProvider.usersSelector.withPolicyMixin

```jsonnet
spec.parameters.forProvider.usersSelector.withPolicyMixin(value)
```
...
Policies for selection.
####### obj spec.parameters.forProvider.usersSelector.policy


######## fn spec.parameters.forProvider.usersSelector.policy.withResolution

```jsonnet
spec.parameters.forProvider.usersSelector.policy.withResolution(value="Required")
```
...
reference cannot be resolved. 'Optional' means this reference will be
a no-op if it cannot be resolved.
######## fn spec.parameters.forProvider.usersSelector.policy.withResolve

```jsonnet
spec.parameters.forProvider.usersSelector.policy.withResolve(value)
```
...
call users (for single_event and recurrent_event event type).
The list of on-call users (for single_event and recurrent_event event type).
###### fn spec.parameters.initProvider.withUsersRef

```jsonnet
spec.parameters.initProvider.withUsersRef(value)
```
...
References to User in oncall to populate users.
###### fn spec.parameters.initProvider.withUsersRefMixin

```jsonnet
spec.parameters.initProvider.withUsersRefMixin(value)
```
...
References to User in oncall to populate users.
###### fn spec.parameters.initProvider.withUsersSelector

```jsonnet
spec.parameters.initProvider.withUsersSelector(value)
```
...
Selector for a list of User in oncall to populate users.
###### fn spec.parameters.initProvider.withUsersSelectorMixin

```jsonnet
spec.parameters.initProvider.withUsersSelectorMixin(value)
```
...
the corresponding field is not present. Use 'Always' to resolve the
reference on every reconcile.
###### obj spec.parameters.initProvider.usersSelector


####### fn spec.parameters.initProvider.usersSelector.withMatchControllerRef

```jsonnet
spec.parameters.initProvider.usersSelector.withMatchControllerRef(value=true)
```
...
MatchControllerRef ensures an object with the same controller reference
as the selecting object is selected.
####### fn spec.parameters.initProvider.usersSelector.withMatchLabels

```jsonnet
spec.parameters.initProvider.usersSelector.withMatchLabels(value)
```
...
MatchLabels ensures an object with matching labels is selected.
####### fn spec.parameters.initProvider.usersSelector.withMatchLabelsMixin

```jsonnet
spec.parameters.initProvider.usersSelector.withMatchLabelsMixin(value)
```
...
MatchLabels ensures an object with matching labels is selected.
####### fn spec.parameters.initProvider.usersSelector.withPolicy

```jsonnet
spec.parameters.initProvider.usersSelector.withPolicy(value)
```
...
Policies for selection.
####### fn spec.parameters.initProvider.usersSelector.withPolicyMixin

```jsonnet
spec.parameters.initProvider.usersSelector.withPolicyMixin(value)
```
...
Policies for selection.
####### obj spec.parameters.initProvider.usersSelector.policy


######## fn spec.parameters.initProvider.usersSelector.policy.withResolution

```jsonnet
spec.parameters.initProvider.usersSelector.policy.withResolution(value="Required")
```
...
reference cannot be resolved. 'Optional' means this reference will be
a no-op if it cannot be resolved.
######## fn spec.parameters.initProvider.usersSelector.policy.withResolve

```jsonnet
spec.parameters.initProvider.usersSelector.policy.withResolve(value)
```
