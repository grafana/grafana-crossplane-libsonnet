# stackServiceAccountRotatingToken
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj parameters`](#obj-specparameters)
    ...
    * [`obj forProvider`](#obj-specparametersforprovider)
      ...
      * [`fn withEarlyRotationWindowSeconds(value)`](#fn-specparametersforproviderwithearlyrotationwindowseconds)
    ...
    * [`obj initProvider`](#obj-specparametersinitprovider)
      ...
      * [`fn withEarlyRotationWindowSeconds(value)`](#fn-specparametersinitproviderwithearlyrotationwindowseconds)
...
###### fn spec.parameters.forProvider.withEarlyRotationWindowSeconds

```jsonnet
spec.parameters.forProvider.withEarlyRotationWindowSeconds(value)
```
...
Use it with lifecycle { create_before_destroy = true } to make sure that the new token is created before the old one is deleted. Defaults to false. Use it with `lifecycle { create_before_destroy = true }` to make sure that the new token is created before the old one is deleted. Defaults to `false`.
###### fn spec.parameters.initProvider.withEarlyRotationWindowSeconds

```jsonnet
spec.parameters.initProvider.withEarlyRotationWindowSeconds(value)
```
