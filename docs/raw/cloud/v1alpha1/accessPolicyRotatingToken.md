...
* [`obj spec`](#obj-spec)
  ...
  * [`obj parameters`](#obj-specparameters)
    ...
    * [`obj forProvider`](#obj-specparametersforprovider)
      ...
      * [`fn withDeleteOnDestroy(value=true)`](#fn-specparametersforproviderwithdeleteondestroy)
      * [`fn withDisplayName(value)`](#fn-specparametersforproviderwithdisplayname)
      * [`fn withEarlyRotationWindow(value)`](#fn-specparametersforproviderwithearlyrotationwindow)
      * [`fn withExpireAfter(value)`](#fn-specparametersforproviderwithexpireafter)
      * [`fn withNamePrefix(value)`](#fn-specparametersforproviderwithnameprefix)
    ...
    * [`obj initProvider`](#obj-specparametersinitprovider)
      ...
      * [`fn withDeleteOnDestroy(value=true)`](#fn-specparametersinitproviderwithdeleteondestroy)
      * [`fn withDisplayName(value)`](#fn-specparametersinitproviderwithdisplayname)
      * [`fn withEarlyRotationWindow(value)`](#fn-specparametersinitproviderwithearlyrotationwindow)
      * [`fn withExpireAfter(value)`](#fn-specparametersinitproviderwithexpireafter)
      * [`fn withNamePrefix(value)`](#fn-specparametersinitproviderwithnameprefix)
...
###### fn spec.parameters.forProvider.withDeleteOnDestroy

```jsonnet
spec.parameters.forProvider.withDeleteOnDestroy(value=true)
```
...
###### fn spec.parameters.forProvider.withEarlyRotationWindow

```jsonnet
spec.parameters.forProvider.withEarlyRotationWindow(value)
```
...
```jsonnet
spec.parameters.forProvider.withExpireAfter(value)
```
...
```jsonnet
spec.parameters.forProvider.withNamePrefix(value)
```
...
(String) ID of the access policy for which to create a token.
ID of the access policy for which to create a token.
###### fn spec.parameters.initProvider.withDeleteOnDestroy

```jsonnet
spec.parameters.initProvider.withDeleteOnDestroy(value=true)
```
...
(String) Display name of the access policy token. Defaults to the name.
Display name of the access policy token. Defaults to the name.
###### fn spec.parameters.initProvider.withEarlyRotationWindow

```jsonnet
spec.parameters.initProvider.withEarlyRotationWindow(value)
```
...
```jsonnet
spec.parameters.initProvider.withExpireAfter(value)
```
...
```jsonnet
spec.parameters.initProvider.withNamePrefix(value)
```
