  ...
  * [`obj parameters`](#obj-specparameters)
    ...
    * [`obj forProvider`](#obj-specparametersforprovider)
      ...
      * [`obj spec`](#obj-specparametersforproviderspec)
        * [`fn withDecrypters(value)`](#fn-specparametersforproviderspecwithdecrypters)
        * [`fn withDecryptersMixin(value)`](#fn-specparametersforproviderspecwithdecryptersmixin)
        * [`fn withDescription(value)`](#fn-specparametersforproviderspecwithdescription)
        * [`fn withRef(value)`](#fn-specparametersforproviderspecwithref)
        * [`fn withValueSecretRef(value)`](#fn-specparametersforproviderspecwithvaluesecretref)
        * [`fn withValueSecretRefMixin(value)`](#fn-specparametersforproviderspecwithvaluesecretrefmixin)
        * [`obj valueSecretRef`](#obj-specparametersforproviderspecvaluesecretref)
          * [`fn withKey(value)`](#fn-specparametersforproviderspecvaluesecretrefwithkey)
          * [`fn withName(value)`](#fn-specparametersforproviderspecvaluesecretrefwithname)
          * [`fn withNamespace(value)`](#fn-specparametersforproviderspecvaluesecretrefwithnamespace)
    * [`obj initProvider`](#obj-specparametersinitprovider)
      ...
      * [`obj spec`](#obj-specparametersinitproviderspec)
        * [`fn withDecrypters(value)`](#fn-specparametersinitproviderspecwithdecrypters)
        * [`fn withDecryptersMixin(value)`](#fn-specparametersinitproviderspecwithdecryptersmixin)
        * [`fn withDescription(value)`](#fn-specparametersinitproviderspecwithdescription)
        * [`fn withRef(value)`](#fn-specparametersinitproviderspecwithref)
        * [`fn withValueSecretRef(value)`](#fn-specparametersinitproviderspecwithvaluesecretref)
        * [`fn withValueSecretRefMixin(value)`](#fn-specparametersinitproviderspecwithvaluesecretrefmixin)
        * [`obj valueSecretRef`](#obj-specparametersinitproviderspecvaluesecretref)
          * [`fn withKey(value)`](#fn-specparametersinitproviderspecvaluesecretrefwithkey)
          * [`fn withName(value)`](#fn-specparametersinitproviderspecvaluesecretrefwithname)
          * [`fn withNamespace(value)`](#fn-specparametersinitproviderspecvaluesecretrefwithnamespace)
...
####### fn spec.parameters.forProvider.spec.withDecrypters

```jsonnet
spec.parameters.forProvider.spec.withDecrypters(value)
```
...
####### fn spec.parameters.forProvider.spec.withDecryptersMixin

```jsonnet
spec.parameters.forProvider.spec.withDecryptersMixin(value)
```
...
####### fn spec.parameters.forProvider.spec.withRef

```jsonnet
spec.parameters.forProvider.spec.withRef(value)
```
...
####### fn spec.parameters.forProvider.spec.withValueSecretRef

```jsonnet
spec.parameters.forProvider.spec.withValueSecretRef(value)
```
...
####### fn spec.parameters.forProvider.spec.withValueSecretRefMixin

```jsonnet
spec.parameters.forProvider.spec.withValueSecretRefMixin(value)
```
...
Plaintext value to store. This value is write-only.
####### obj spec.parameters.forProvider.spec.valueSecretRef


######## fn spec.parameters.forProvider.spec.valueSecretRef.withKey

```jsonnet
spec.parameters.forProvider.spec.valueSecretRef.withKey(value)
```
...
The key to select.
######## fn spec.parameters.forProvider.spec.valueSecretRef.withName

```jsonnet
spec.parameters.forProvider.spec.valueSecretRef.withName(value)
```
...
Name of the secret.
######## fn spec.parameters.forProvider.spec.valueSecretRef.withNamespace

```jsonnet
spec.parameters.forProvider.spec.valueSecretRef.withNamespace(value)
```
...
####### fn spec.parameters.initProvider.spec.withDecrypters

```jsonnet
spec.parameters.initProvider.spec.withDecrypters(value)
```
...
List of decrypters allowed to read this secure value.
####### fn spec.parameters.initProvider.spec.withDecryptersMixin

```jsonnet
spec.parameters.initProvider.spec.withDecryptersMixin(value)
```
...
Secure value description.
####### fn spec.parameters.initProvider.spec.withRef

```jsonnet
spec.parameters.initProvider.spec.withRef(value)
```
...
Reference to an existing secret managed by the keeper.
####### fn spec.parameters.initProvider.spec.withValueSecretRef

```jsonnet
spec.parameters.initProvider.spec.withValueSecretRef(value)
```
...
Plaintext value to store. This value is write-only.
####### fn spec.parameters.initProvider.spec.withValueSecretRefMixin

```jsonnet
spec.parameters.initProvider.spec.withValueSecretRefMixin(value)
```
...
Plaintext value to store. This value is write-only.
####### obj spec.parameters.initProvider.spec.valueSecretRef


######## fn spec.parameters.initProvider.spec.valueSecretRef.withKey

```jsonnet
spec.parameters.initProvider.spec.valueSecretRef.withKey(value)
```
...
The key to select.
######## fn spec.parameters.initProvider.spec.valueSecretRef.withName

```jsonnet
spec.parameters.initProvider.spec.valueSecretRef.withName(value)
```
...
Name of the secret.
######## fn spec.parameters.initProvider.spec.valueSecretRef.withNamespace

```jsonnet
spec.parameters.initProvider.spec.valueSecretRef.withNamespace(value)
```
