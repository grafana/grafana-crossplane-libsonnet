...
* [`obj spec`](#obj-spec)
  ...
  * [`obj parameters`](#obj-specparameters)
    ...
    * [`obj forProvider`](#obj-specparametersforprovider)
      ...
      * [`fn withTtlQueriesMs(value)`](#fn-specparametersforproviderwithttlqueriesms)
      * [`fn withTtlResourcesMs(value)`](#fn-specparametersforproviderwithttlresourcesms)
      * [`fn withUseDefaultTtl(value=true)`](#fn-specparametersforproviderwithusedefaultttl)
    ...
    * [`obj initProvider`](#obj-specparametersinitprovider)
      ...
      * [`fn withTtlQueriesMs(value)`](#fn-specparametersinitproviderwithttlqueriesms)
      * [`fn withTtlResourcesMs(value)`](#fn-specparametersinitproviderwithttlresourcesms)
      * [`fn withUseDefaultTtl(value=true)`](#fn-specparametersinitproviderwithusedefaultttl)
...
Selector for a Organization in oss to populate orgId.
###### fn spec.parameters.forProvider.withTtlQueriesMs

```jsonnet
spec.parameters.forProvider.withTtlQueriesMs(value)
```
...
###### fn spec.parameters.forProvider.withTtlResourcesMs

```jsonnet
spec.parameters.forProvider.withTtlResourcesMs(value)
```
...
###### fn spec.parameters.forProvider.withUseDefaultTtl

```jsonnet
spec.parameters.forProvider.withUseDefaultTtl(value=true)
```
...
Selector for a Organization in oss to populate orgId.
###### fn spec.parameters.initProvider.withTtlQueriesMs

```jsonnet
spec.parameters.initProvider.withTtlQueriesMs(value)
```
...
(Number) TTL for query caching, in milliseconds. Ignored if use_default_ttl is true.
TTL for query caching, in milliseconds. Ignored if use_default_ttl is true.
###### fn spec.parameters.initProvider.withTtlResourcesMs

```jsonnet
spec.parameters.initProvider.withTtlResourcesMs(value)
```
...
(Number) TTL for resource caching, in milliseconds. Ignored if use_default_ttl is true.
TTL for resource caching, in milliseconds. Ignored if use_default_ttl is true.
###### fn spec.parameters.initProvider.withUseDefaultTtl

```jsonnet
spec.parameters.initProvider.withUseDefaultTtl(value=true)
```
