...
* [spec.parameters.forProvider.healthThresholds](spec/parameters/forProvider/healthThresholds.md)
* [spec.parameters.forProvider.requestThresholds](spec/parameters/forProvider/requestThresholds.md)
* [spec.parameters.forProvider.resourceThresholds](spec/parameters/forProvider/resourceThresholds.md)
* [spec.parameters.initProvider.healthThresholds](spec/parameters/initProvider/healthThresholds.md)
* [spec.parameters.initProvider.requestThresholds](spec/parameters/initProvider/requestThresholds.md)
* [spec.parameters.initProvider.resourceThresholds](spec/parameters/initProvider/resourceThresholds.md)
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj parameters`](#obj-specparameters)
    ...
    * [`obj forProvider`](#obj-specparametersforprovider)
      * [`fn withHealthThresholds(value)`](#fn-specparametersforproviderwithhealththresholds)
      * [`fn withHealthThresholdsMixin(value)`](#fn-specparametersforproviderwithhealththresholdsmixin)
      * [`fn withRequestThresholds(value)`](#fn-specparametersforproviderwithrequestthresholds)
      * [`fn withRequestThresholdsMixin(value)`](#fn-specparametersforproviderwithrequestthresholdsmixin)
      * [`fn withResourceThresholds(value)`](#fn-specparametersforproviderwithresourcethresholds)
      * [`fn withResourceThresholdsMixin(value)`](#fn-specparametersforproviderwithresourcethresholdsmixin)
    * [`obj initProvider`](#obj-specparametersinitprovider)
      * [`fn withHealthThresholds(value)`](#fn-specparametersinitproviderwithhealththresholds)
      * [`fn withHealthThresholdsMixin(value)`](#fn-specparametersinitproviderwithhealththresholdsmixin)
      * [`fn withRequestThresholds(value)`](#fn-specparametersinitproviderwithrequestthresholds)
      * [`fn withRequestThresholdsMixin(value)`](#fn-specparametersinitproviderwithrequestthresholdsmixin)
      * [`fn withResourceThresholds(value)`](#fn-specparametersinitproviderwithresourcethresholds)
      * [`fn withResourceThresholdsMixin(value)`](#fn-specparametersinitproviderwithresourcethresholdsmixin)
...
###### fn spec.parameters.forProvider.withHealthThresholds

```jsonnet
spec.parameters.forProvider.withHealthThresholds(value)
```
...
###### fn spec.parameters.forProvider.withHealthThresholdsMixin

```jsonnet
spec.parameters.forProvider.withHealthThresholdsMixin(value)
```
...
(Block List) List of health thresholds. (see below for nested schema)
List of health thresholds.
###### fn spec.parameters.forProvider.withRequestThresholds

```jsonnet
spec.parameters.forProvider.withRequestThresholds(value)
```
...
###### fn spec.parameters.forProvider.withRequestThresholdsMixin

```jsonnet
spec.parameters.forProvider.withRequestThresholdsMixin(value)
```
...
(Block List) List of request thresholds. (see below for nested schema)
List of request thresholds.
###### fn spec.parameters.forProvider.withResourceThresholds

```jsonnet
spec.parameters.forProvider.withResourceThresholds(value)
```
...
###### fn spec.parameters.forProvider.withResourceThresholdsMixin

```jsonnet
spec.parameters.forProvider.withResourceThresholdsMixin(value)
```
...
###### fn spec.parameters.initProvider.withHealthThresholds

```jsonnet
spec.parameters.initProvider.withHealthThresholds(value)
```
...
(Block List) List of health thresholds. (see below for nested schema)
List of health thresholds.
###### fn spec.parameters.initProvider.withHealthThresholdsMixin

```jsonnet
spec.parameters.initProvider.withHealthThresholdsMixin(value)
```
...
(Block List) List of health thresholds. (see below for nested schema)
List of health thresholds.
###### fn spec.parameters.initProvider.withRequestThresholds

```jsonnet
spec.parameters.initProvider.withRequestThresholds(value)
```
...
(Block List) List of request thresholds. (see below for nested schema)
List of request thresholds.
###### fn spec.parameters.initProvider.withRequestThresholdsMixin

```jsonnet
spec.parameters.initProvider.withRequestThresholdsMixin(value)
```
...
(Block List) List of request thresholds. (see below for nested schema)
List of request thresholds.
###### fn spec.parameters.initProvider.withResourceThresholds

```jsonnet
spec.parameters.initProvider.withResourceThresholds(value)
```
...
(Block List) List of resource thresholds. (see below for nested schema)
List of resource thresholds.
###### fn spec.parameters.initProvider.withResourceThresholdsMixin

```jsonnet
spec.parameters.initProvider.withResourceThresholdsMixin(value)
```
