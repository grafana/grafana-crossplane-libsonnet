...
* [spec.parameters.forProvider.dataset](spec/parameters/forProvider/dataset/index.md)
* [spec.parameters.initProvider.dataset](spec/parameters/initProvider/dataset/index.md)
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj parameters`](#obj-specparameters)
    ...
    * [`obj forProvider`](#obj-specparametersforprovider)
      ...
      * [`fn withDataset(value)`](#fn-specparametersforproviderwithdataset)
      * [`fn withDatasetMixin(value)`](#fn-specparametersforproviderwithdatasetmixin)
      * [`fn withGrafanaTokenSecretRef(value)`](#fn-specparametersforproviderwithgrafanatokensecretref)
      * [`fn withGrafanaTokenSecretRefMixin(value)`](#fn-specparametersforproviderwithgrafanatokensecretrefmixin)
      ...
      * [`obj grafanaTokenSecretRef`](#obj-specparametersforprovidergrafanatokensecretref)
        * [`fn withKey(value)`](#fn-specparametersforprovidergrafanatokensecretrefwithkey)
        * [`fn withName(value)`](#fn-specparametersforprovidergrafanatokensecretrefwithname)
        * [`fn withNamespace(value)`](#fn-specparametersforprovidergrafanatokensecretrefwithnamespace)
    * [`obj initProvider`](#obj-specparametersinitprovider)
      ...
      * [`fn withDataset(value)`](#fn-specparametersinitproviderwithdataset)
      * [`fn withDatasetMixin(value)`](#fn-specparametersinitproviderwithdatasetmixin)
      * [`fn withGrafanaTokenSecretRef(value)`](#fn-specparametersinitproviderwithgrafanatokensecretref)
      * [`fn withGrafanaTokenSecretRefMixin(value)`](#fn-specparametersinitproviderwithgrafanatokensecretrefmixin)
      ...
      * [`obj grafanaTokenSecretRef`](#obj-specparametersinitprovidergrafanatokensecretref)
        * [`fn withKey(value)`](#fn-specparametersinitprovidergrafanatokensecretrefwithkey)
        * [`fn withName(value)`](#fn-specparametersinitprovidergrafanatokensecretrefwithname)
        * [`fn withNamespace(value)`](#fn-specparametersinitprovidergrafanatokensecretrefwithnamespace)
...
(String, Sensitive) A Grafana Cloud Access Policy token with the following scopes: stacks:read, metrics:read, metrics:write. This token is used for GCom API access, Mimir authentication, and assertion detector webhook authentication.
A Grafana Cloud Access Policy token with the following scopes: `stacks:read`, `metrics:read`, `metrics:write`. This token is used for GCom API access, Mimir authentication, and assertion detector webhook authentication.
###### fn spec.parameters.forProvider.withDataset

```jsonnet
spec.parameters.forProvider.withDataset(value)
```
...
###### fn spec.parameters.forProvider.withDatasetMixin

```jsonnet
spec.parameters.forProvider.withDatasetMixin(value)
```
...
detection. Use this when your metrics use non-standard label names (e.g., a custom environment label). (see below for nested schema)
Manual dataset configuration. When specified, datasets are configured manually instead of using auto-detection. Use this when your metrics use non-standard label names (e.g., a custom environment label).
###### fn spec.parameters.forProvider.withGrafanaTokenSecretRef

```jsonnet
spec.parameters.forProvider.withGrafanaTokenSecretRef(value)
```
...
###### fn spec.parameters.forProvider.withGrafanaTokenSecretRefMixin

```jsonnet
spec.parameters.forProvider.withGrafanaTokenSecretRefMixin(value)
```
...
###### obj spec.parameters.forProvider.grafanaTokenSecretRef


####### fn spec.parameters.forProvider.grafanaTokenSecretRef.withKey

```jsonnet
spec.parameters.forProvider.grafanaTokenSecretRef.withKey(value)
```
...
The key to select.
####### fn spec.parameters.forProvider.grafanaTokenSecretRef.withName

```jsonnet
spec.parameters.forProvider.grafanaTokenSecretRef.withName(value)
```
...
Name of the secret.
####### fn spec.parameters.forProvider.grafanaTokenSecretRef.withNamespace

```jsonnet
spec.parameters.forProvider.grafanaTokenSecretRef.withNamespace(value)
```
...
(String, Sensitive) A Grafana Cloud Access Policy token with the following scopes: stacks:read, metrics:read, metrics:write. This token is used for GCom API access, Mimir authentication, and assertion detector webhook authentication.
A Grafana Cloud Access Policy token with the following scopes: `stacks:read`, `metrics:read`, `metrics:write`. This token is used for GCom API access, Mimir authentication, and assertion detector webhook authentication.
###### fn spec.parameters.initProvider.withDataset

```jsonnet
spec.parameters.initProvider.withDataset(value)
```
...
detection. Use this when your metrics use non-standard label names (e.g., a custom environment label). (see below for nested schema)
Manual dataset configuration. When specified, datasets are configured manually instead of using auto-detection. Use this when your metrics use non-standard label names (e.g., a custom environment label).
###### fn spec.parameters.initProvider.withDatasetMixin

```jsonnet
spec.parameters.initProvider.withDatasetMixin(value)
```
...
detection. Use this when your metrics use non-standard label names (e.g., a custom environment label). (see below for nested schema)
Manual dataset configuration. When specified, datasets are configured manually instead of using auto-detection. Use this when your metrics use non-standard label names (e.g., a custom environment label).
###### fn spec.parameters.initProvider.withGrafanaTokenSecretRef

```jsonnet
spec.parameters.initProvider.withGrafanaTokenSecretRef(value)
```
...
(String, Sensitive) A Grafana Service Account token for installing dashboards and Grafana Managed Alerts. Required permissions: dashboards:create, dashboards:write, dashboards:read, folders:create, folders:write, folders:read, folders:delete, datasources:read, datasources:query, alert.provisioning:write, alert.notifications.provisioning:write, alert.notifications:write, alert.rules:read, alert.rules:create, alert.rules:delete. Create using grafana_cloud_stack_service_account_token resource.
A Grafana Service Account token for installing dashboards and Grafana Managed Alerts. Required permissions: `dashboards:create`, `dashboards:write`, `dashboards:read`, `folders:create`, `folders:write`, `folders:read`, `folders:delete`, `datasources:read`, `datasources:query`, `alert.provisioning:write`, `alert.notifications.provisioning:write`, `alert.notifications:write`, `alert.rules:read`, `alert.rules:create`, `alert.rules:delete`. Create using `grafana_cloud_stack_service_account_token` resource.
###### fn spec.parameters.initProvider.withGrafanaTokenSecretRefMixin

```jsonnet
spec.parameters.initProvider.withGrafanaTokenSecretRefMixin(value)
```
...
Namespace of the secret.
###### obj spec.parameters.initProvider.grafanaTokenSecretRef


####### fn spec.parameters.initProvider.grafanaTokenSecretRef.withKey

```jsonnet
spec.parameters.initProvider.grafanaTokenSecretRef.withKey(value)
```
...
The key to select.
####### fn spec.parameters.initProvider.grafanaTokenSecretRef.withName

```jsonnet
spec.parameters.initProvider.grafanaTokenSecretRef.withName(value)
```
...
Name of the secret.
####### fn spec.parameters.initProvider.grafanaTokenSecretRef.withNamespace

```jsonnet
spec.parameters.initProvider.grafanaTokenSecretRef.withNamespace(value)
```
