...
* [spec.parameters.forProvider.group](spec/parameters/forProvider/group/index.md)
* [spec.parameters.initProvider.group](spec/parameters/initProvider/group/index.md)
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj parameters`](#obj-specparameters)
    ...
    * [`obj forProvider`](#obj-specparametersforprovider)
      * [`fn withActive(value=true)`](#fn-specparametersforproviderwithactive)
      * [`fn withGroup(value)`](#fn-specparametersforproviderwithgroup)
      * [`fn withGroupMixin(value)`](#fn-specparametersforproviderwithgroupmixin)
      * [`fn withName(value)`](#fn-specparametersforproviderwithname)
    * [`obj initProvider`](#obj-specparametersinitprovider)
      * [`fn withActive(value=true)`](#fn-specparametersinitproviderwithactive)
      * [`fn withGroup(value)`](#fn-specparametersinitproviderwithgroup)
      * [`fn withGroupMixin(value)`](#fn-specparametersinitproviderwithgroupmixin)
...
###### fn spec.parameters.forProvider.withActive

```jsonnet
spec.parameters.forProvider.withActive(value=true)
```
...
###### fn spec.parameters.forProvider.withGroupMixin

```jsonnet
spec.parameters.forProvider.withGroupMixin(value)
```
...
###### fn spec.parameters.initProvider.withActive

```jsonnet
spec.parameters.initProvider.withActive(value=true)
```
...
(Block List, Min: 1) List of Prometheus rule groups. Each group contains one or more rules and can have its own evaluation interval. (see below for nested schema)
List of Prometheus rule groups. Each group contains one or more rules and can have its own evaluation interval.
###### fn spec.parameters.initProvider.withGroupMixin

```jsonnet
spec.parameters.initProvider.withGroupMixin(value)
```
