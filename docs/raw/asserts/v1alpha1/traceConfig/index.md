...
* [`obj spec`](#obj-spec)
  ...
  * [`obj parameters`](#obj-specparameters)
    ...
    * [`obj forProvider`](#obj-specparametersforprovider)
      ...
      * [`fn withEntityPropertyToTraceLabelMapping(value)`](#fn-specparametersforproviderwithentitypropertytotracelabelmapping)
      * [`fn withEntityPropertyToTraceLabelMappingMixin(value)`](#fn-specparametersforproviderwithentitypropertytotracelabelmappingmixin)
    ...
    * [`obj initProvider`](#obj-specparametersinitprovider)
      ...
      * [`fn withEntityPropertyToTraceLabelMapping(value)`](#fn-specparametersinitproviderwithentitypropertytotracelabelmapping)
      * [`fn withEntityPropertyToTraceLabelMappingMixin(value)`](#fn-specparametersinitproviderwithentitypropertytotracelabelmappingmixin)
...
###### fn spec.parameters.forProvider.withEntityPropertyToTraceLabelMapping

```jsonnet
spec.parameters.forProvider.withEntityPropertyToTraceLabelMapping(value)
```
...
###### fn spec.parameters.forProvider.withEntityPropertyToTraceLabelMappingMixin

```jsonnet
spec.parameters.forProvider.withEntityPropertyToTraceLabelMappingMixin(value)
```
...
(Boolean) Is it the default config, therefore undeletable?
Is it the default config, therefore undeletable?
###### fn spec.parameters.initProvider.withEntityPropertyToTraceLabelMapping

```jsonnet
spec.parameters.initProvider.withEntityPropertyToTraceLabelMapping(value)
```
...
(Map of String) Mapping of entity properties to trace labels.
Mapping of entity properties to trace labels.
###### fn spec.parameters.initProvider.withEntityPropertyToTraceLabelMappingMixin

```jsonnet
spec.parameters.initProvider.withEntityPropertyToTraceLabelMappingMixin(value)
```
