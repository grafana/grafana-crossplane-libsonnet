{
  ...
  forProvider+:
    {
      '#withAlertsEnabled': { 'function': { args: [{ default: true, enums: null, name: 'value', type: ['boolean'] }], help: '(Boolean) Whether alerts are enabled for this integration.\nWhether alerts are enabled for this integration.' } },
      withAlertsEnabled(value=true): {
        spec+: {
          parameters+: {
            forProvider+: {
              alertsEnabled: value,
      ...
      '#withSlug': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: "node').\nThe slug of the integration to install (e.g., 'docker', 'linux-node')." } },
      withSlug(value): {
        spec+: {
          parameters+: {
            forProvider+: {
