{
  ...
  '#withParameters': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'AlertruleV0Alpha1Spec defines the desired state of AlertruleV0Alpha1' } },
  withParameters(value): {
    spec+: {
      parameters: value,
    },
  },
  '#withParametersMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'AlertruleV0Alpha1Spec defines the desired state of AlertruleV0Alpha1' } },
