{
  ...
  '#withParameters': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'InhibitionruleV1Beta1Spec defines the desired state of InhibitionruleV1Beta1' } },
  withParameters(value): {
    spec+: {
      parameters: value,
    },
  },
  '#withParametersMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'InhibitionruleV1Beta1Spec defines the desired state of InhibitionruleV1Beta1' } },
