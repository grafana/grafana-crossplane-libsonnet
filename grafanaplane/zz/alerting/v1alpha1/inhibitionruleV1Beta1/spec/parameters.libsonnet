  ...
  forProvider+:
    {
      ...
      metadata+:
        {
          '#withFolderUid': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: "The UID of the folder to save the resource in. For example, it's supported for dashboards and folders. To know if it's supported for the specific resource you're using check the documentation." } },
          withFolderUid(value): {
            spec+: {
              parameters+: {
                forProvider+: {
      ...
      spec+:
        {
          '#withEqual': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: 'Labels that must have equal values in source and target alerts for the inhibition to take effect.' } },
          withEqual(value): {
            spec+: {
              parameters+: {
                forProvider+: {
          ...
          '#withEqualMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: 'Labels that must have equal values in source and target alerts for the inhibition to take effect.' } },
          ...
          '#withSourceMatchers': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: 'Matchers that must be satisfied for an alert to be a source of inhibition.' } },
          ...
          '#withSourceMatchersMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: 'Matchers that must be satisfied for an alert to be a source of inhibition.' } },
          ...
          '#withTargetMatchers': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: 'Matchers that must be satisfied for an alert to be inhibited.' } },
          ...
          '#withTargetMatchersMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: 'Matchers that must be satisfied for an alert to be inhibited.' } },
