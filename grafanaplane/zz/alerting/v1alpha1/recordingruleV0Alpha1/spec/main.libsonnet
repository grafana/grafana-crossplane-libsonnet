{
  ...
  '#withParameters': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'RecordingruleV0Alpha1Spec defines the desired state of RecordingruleV0Alpha1' } },
  withParameters(value): {
    spec+: {
      parameters: value,
    },
  },
  '#withParametersMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'RecordingruleV0Alpha1Spec defines the desired state of RecordingruleV0Alpha1' } },
