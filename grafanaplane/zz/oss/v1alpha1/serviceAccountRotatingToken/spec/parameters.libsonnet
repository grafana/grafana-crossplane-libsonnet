  ...
  forProvider+:
    {
      ...
      '#withEarlyRotationWindowSeconds': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['number'] }], help: '(Number) Duration of the time window before expiring where the token can be rotated, in seconds.\nDuration of the time window before expiring where the token can be rotated, in seconds.' } },
      withEarlyRotationWindowSeconds(value): {
        spec+: {
          parameters+: {
            forProvider+: {
              earlyRotationWindowSeconds: value,
            },
          },
        },
      },
      '#withNamePrefix': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '<additional_characters>.\nPrefix for the name of the service account tokens created by this resource. The actual name will be stored in the computed field `name`, which will be in the format `<name_prefix>-<additional_characters>`.' } },
      ...
      '#withSecondsToLive': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['number'] }], help: '(Number) The token expiration in seconds.\nThe token expiration in seconds.' } },
