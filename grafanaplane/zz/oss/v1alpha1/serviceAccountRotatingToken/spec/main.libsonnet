{
  ...
  '#withParameters': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'ServiceAccountRotatingTokenSpec defines the desired state of ServiceAccountRotatingToken' } },
  withParameters(value): {
    spec+: {
      parameters: value,
    },
  },
  '#withParametersMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'ServiceAccountRotatingTokenSpec defines the desired state of ServiceAccountRotatingToken' } },
