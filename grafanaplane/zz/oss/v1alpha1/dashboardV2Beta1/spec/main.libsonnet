{
  ...
  '#withParameters': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'DashboardV2Beta1Spec defines the desired state of DashboardV2Beta1' } },
  withParameters(value): {
    spec+: {
      parameters: value,
    },
  },
  '#withParametersMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'DashboardV2Beta1Spec defines the desired state of DashboardV2Beta1' } },
