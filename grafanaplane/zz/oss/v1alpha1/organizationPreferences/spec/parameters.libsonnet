  ...
  forProvider+:
    {
      ...
      '#withTheme': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) The Organization theme. Any string value is supported, including custom themes. Common values are light, dark, system, or an empty string for the default.\nThe Organization theme. Any string value is supported, including custom themes. Common values are `light`, `dark`, `system`, or an empty string for the default.' } },
      withTheme(value): {
        spec+: {
          parameters+: {
            forProvider+: {
      ...
      '#withTimezone': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) The Organization timezone. Any string value is supported, including IANA timezone names. Common values are utc, browser, or an empty string for the default.\nThe Organization timezone. Any string value is supported, including IANA timezone names. Common values are `utc`, `browser`, or an empty string for the default.' } },
      withTimezone(value): {
        spec+: {
          parameters+: {
            forProvider+: {
