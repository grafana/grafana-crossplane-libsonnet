{
  ...
  '#withParameters': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'ConnectionV0Alpha1Spec defines the desired state of ConnectionV0Alpha1' } },
  withParameters(value): {
    spec+: {
      parameters: value,
    },
  },
  '#withParametersMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'ConnectionV0Alpha1Spec defines the desired state of ConnectionV0Alpha1' } },
