{
  ...
  '#withParameters': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'RepositoryV0Alpha1Spec defines the desired state of RepositoryV0Alpha1' } },
  withParameters(value): {
    spec+: {
      parameters: value,
    },
  },
  '#withParametersMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'RepositoryV0Alpha1Spec defines the desired state of RepositoryV0Alpha1' } },
