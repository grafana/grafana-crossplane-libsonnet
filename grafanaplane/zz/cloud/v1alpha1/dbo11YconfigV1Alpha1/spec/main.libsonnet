{
  ...
  '#withParameters': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'Dbo11YconfigV1Alpha1Spec defines the desired state of Dbo11YconfigV1Alpha1' } },
  withParameters(value): {
    spec+: {
      parameters: value,
    },
  },
  '#withParametersMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'Dbo11YconfigV1Alpha1Spec defines the desired state of Dbo11YconfigV1Alpha1' } },
