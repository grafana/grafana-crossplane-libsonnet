{
  ...
  '#withParameters': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'AccessPolicyRotatingTokenSpec defines the desired state of AccessPolicyRotatingToken' } },
  withParameters(value): {
    spec+: {
      parameters: value,
    },
  },
  '#withParametersMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'AccessPolicyRotatingTokenSpec defines the desired state of AccessPolicyRotatingToken' } },
