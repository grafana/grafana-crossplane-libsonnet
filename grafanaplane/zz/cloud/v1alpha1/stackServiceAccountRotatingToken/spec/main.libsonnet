{
  ...
  '#withParameters': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'StackServiceAccountRotatingTokenSpec defines the desired state of StackServiceAccountRotatingToken' } },
  withParameters(value): {
    spec+: {
      parameters: value,
    },
  },
  '#withParametersMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'StackServiceAccountRotatingTokenSpec defines the desired state of StackServiceAccountRotatingToken' } },
