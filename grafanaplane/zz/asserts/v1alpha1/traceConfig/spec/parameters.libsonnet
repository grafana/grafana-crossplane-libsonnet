{
  ...
  forProvider+:
    {
      '#withDataSourceUid': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) DataSource to be queried (e.g., a Tempo instance).\nDataSource to be queried (e.g., a Tempo instance).' } },
      ...
      '#withEntityPropertyToTraceLabelMapping': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: '(Map of String) Mapping of entity properties to trace labels.\nMapping of entity properties to trace labels.' } },
      withEntityPropertyToTraceLabelMapping(value): {
        spec+: {
          parameters+: {
            forProvider+: {
              entityPropertyToTraceLabelMapping: value,
            },
          },
        },
      },
      '#withEntityPropertyToTraceLabelMappingMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: '(Map of String) Mapping of entity properties to trace labels.\nMapping of entity properties to trace labels.' } },
      withEntityPropertyToTraceLabelMappingMixin(value): {
        spec+: {
          parameters+: {
            forProvider+: {
              entityPropertyToTraceLabelMapping+: value,
      ...
      '#withName': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) The name of the trace configuration.\nThe name of the trace configuration.' } },
      withName(value): {
        spec+: {
          parameters+: {
            forProvider+: {
      ...
      '#withPriority': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['number'] }], help: '(Number) Priority of the trace configuration. A lower number means a higher priority.\nPriority of the trace configuration. A lower number means a higher priority.' } },
      withPriority(value): {
        spec+: {
          parameters+: {
            forProvider+: {
