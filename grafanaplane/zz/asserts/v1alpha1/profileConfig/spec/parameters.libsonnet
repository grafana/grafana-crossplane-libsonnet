{
  ...
  forProvider+:
    {
      '#withDataSourceUid': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) DataSource to be queried (e.g., a Pyroscope instance).\nDataSource to be queried (e.g., a Pyroscope instance).' } },
      ...
      '#withEntityPropertyToProfileLabelMapping': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: '(Map of String) Mapping of entity properties to profile labels.\nMapping of entity properties to profile labels.' } },
      withEntityPropertyToProfileLabelMapping(value): {
        spec+: {
          parameters+: {
            forProvider+: {
              entityPropertyToProfileLabelMapping: value,
            },
          },
        },
      },
      '#withEntityPropertyToProfileLabelMappingMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: '(Map of String) Mapping of entity properties to profile labels.\nMapping of entity properties to profile labels.' } },
      withEntityPropertyToProfileLabelMappingMixin(value): {
        spec+: {
          parameters+: {
            forProvider+: {
              entityPropertyToProfileLabelMapping+: value,
      ...
      match+:
        {
          '#': { help: '', name: 'match' },
          '#withOp': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) Operation to use for matching. One of: =, <>, <, >, <=, >=, IS NULL, IS NOT NULL, STARTS WITH, CONTAINS.\nOperation to use for matching. One of: =, <>, <, >, <=, >=, IS NULL, IS NOT NULL, STARTS WITH, CONTAINS.' } },
          withOp(value): {
            op: value,
          },
      ...
      '#withName': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) The name of the profile configuration.\nThe name of the profile configuration.' } },
      withName(value): {
        spec+: {
          parameters+: {
            forProvider+: {
      ...
      '#withPriority': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['number'] }], help: '(Number) Priority of the profile configuration. A lower number means a higher priority.\nPriority of the profile configuration. A lower number means a higher priority.' } },
      withPriority(value): {
        spec+: {
          parameters+: {
            forProvider+: {
