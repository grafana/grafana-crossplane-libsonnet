{
  ...
  '#withParameters': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'DataSourceCacheConfigSpec defines the desired state of DataSourceCacheConfig' } },
  withParameters(value): {
    spec+: {
      parameters: value,
    },
  },
  '#withParametersMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'DataSourceCacheConfigSpec defines the desired state of DataSourceCacheConfig' } },
