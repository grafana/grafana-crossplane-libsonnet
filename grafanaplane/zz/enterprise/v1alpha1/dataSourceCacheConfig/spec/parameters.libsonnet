{
  ...
  forProvider+:
    {
      '#withDatasourceUid': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) UID of the data source to configure.\nUID of the data source to configure.' } },
      ...
      '#withEnabled': { 'function': { args: [{ default: true, enums: null, name: 'value', type: ['boolean'] }], help: '(Boolean) Whether caching is enabled for this data source.\nWhether caching is enabled for this data source.' } },
      ...
      '#withTtlQueriesMs': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['number'] }], help: '(Number) TTL for query caching, in milliseconds. Ignored if use_default_ttl is true.\nTTL for query caching, in milliseconds. Ignored if use_default_ttl is true.' } },
      withTtlQueriesMs(value): {
        spec+: {
          parameters+: {
            forProvider+: {
              ttlQueriesMs: value,
      ...
      '#withTtlResourcesMs': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['number'] }], help: '(Number) TTL for resource caching, in milliseconds. Ignored if use_default_ttl is true.\nTTL for resource caching, in milliseconds. Ignored if use_default_ttl is true.' } },
      withTtlResourcesMs(value): {
        spec+: {
          parameters+: {
            forProvider+: {
              ttlResourcesMs: value,
            },
          },
        },
      },
      '#withUseDefaultTtl': { 'function': { args: [{ default: true, enums: null, name: 'value', type: ['boolean'] }], help: "(Boolean) If true, use Grafana's default TTLs instead of custom values. Defaults to true.\nIf true, use Grafana's default TTLs instead of custom values. Defaults to `true`." } },
      withUseDefaultTtl(value=true): {
        spec+: {
          parameters+: {
            forProvider+: {
              useDefaultTtl: value,
