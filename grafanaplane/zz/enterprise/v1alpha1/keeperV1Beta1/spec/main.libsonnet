{
  ...
  '#withParameters': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'KeeperV1Beta1Spec defines the desired state of KeeperV1Beta1' } },
  withParameters(value): {
    spec+: {
      parameters: value,
    },
  },
  '#withParametersMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'KeeperV1Beta1Spec defines the desired state of KeeperV1Beta1' } },
