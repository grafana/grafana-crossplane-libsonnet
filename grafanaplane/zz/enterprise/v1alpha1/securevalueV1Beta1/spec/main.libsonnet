{
  ...
  '#withParameters': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'SecurevalueV1Beta1Spec defines the desired state of SecurevalueV1Beta1' } },
  withParameters(value): {
    spec+: {
      parameters: value,
    },
  },
  '#withParametersMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'SecurevalueV1Beta1Spec defines the desired state of SecurevalueV1Beta1' } },
