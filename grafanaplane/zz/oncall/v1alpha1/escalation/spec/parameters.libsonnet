  ...
  forProvider+:
    {
      ...
      '#withNumAlertsInWindow': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['number'] }], help: '(Number) Number of alerts that must occur within the time window to continue escalation for notify_if_num_alerts_in_window type step.\nNumber of alerts that must occur within the time window to continue escalation for notify_if_num_alerts_in_window type step.' } },
      withNumAlertsInWindow(value): {
        spec+: {
          parameters+: {
            forProvider+: {
              numAlertsInWindow: value,
            },
          },
        },
      },
      '#withNumMinutesInWindow': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['number'] }], help: '(Number) Time window in minutes to count alerts for notify_if_num_alerts_in_window type step.\nTime window in minutes to count alerts for notify_if_num_alerts_in_window type step.' } },
      withNumMinutesInWindow(value): {
        spec+: {
          parameters+: {
            forProvider+: {
              numMinutesInWindow: value,
            },
          },
        },
      },
